                                    ...
                                    <nav class="main-menu">
										...
										if(!empty($login_name)){
                                            if($login_type == "student"){
                                                echo "<li class='active'><a href='#txtarea'>Student Form</a></li>";
                                                echo"<li class='active'><a href='#txtarea'>Profile</a></li>";
                                            }
                                            // Admin/Coordinator/Manager
                                            else if ($login_type == "coordinator" || $login_type == "admin" || $login_type == "manager"){
                                                if($login_type == "manager"){
                                                    echo"<li class='active'><a href='#txtarea'>Faculties</a></li>";
                                                }
                                                else if($login_type == "admin")
                                                {
                                                    ...
                                                    echo"<li class='active'><a href='#txtarea'>My Faculty</a></li>";
                                                    echo"<li class='active'><a href='Manager.php'>Student Management</a></li>";        
                                                }
                                            }
