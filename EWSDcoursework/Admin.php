<?php
	...
	if(isset($_POST["AddCoordinator"])){
		...
		if(empty($sid)){
			array_push($errors,"Management ID is required");
		}
		if(empty($email)){
		...
		if(count($errors) == 0){
            ...
            $insert ="INSERT INTO management_tb(Management_ID,Username,Password,Faculty,Email,Type)VALUES('$sid','$name','$password','$faculty','$email','coordinator')";
